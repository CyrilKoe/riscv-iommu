...
module riscv_iommu #(
    ...
    logic [rv_iommu::VLEN-1:0]         trans_iova;
    ...
    logic [rv_iommu::SVX-1:0]              bad_gpaddr;         // GPA that caused the GPF. Sent through FQ
    ...
    assign axi_aux_req.aw.addr      = {{riscv::XLEN-rv_iommu::PLEN{1'b0}}, spaddr};    // translated address
    ...
    assign axi_aux_req.ar.addr      = {{riscv::XLEN-rv_iommu::PLEN{1'b0}}, spaddr};    // translated address
